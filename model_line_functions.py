...
def SII_doub_gaussian(x, z, sig, inten1, inten2):
	mu1 = 6731*(1+z)
	mu2 = 6717*(1+z)
...
def OIII_Hb_trip_gaussian(x, z, sig, inten1, inten2):
...
def NII_Ha_trip_gaussian(x, z, sig, inten1, inten2):
	ratio =  1.0/line_ratios[line]
	mu1 = 6583*(1+z)
	mu2 = 6562*(1+z)
	mu3 = 6549*(1+z)
